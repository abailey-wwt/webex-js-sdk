      ...
      senders: [
        {
          ...
          onData: (data) => {
            meeting.webrtcStats.processStats({pc: meeting.mediaProperties.peerConnection, stats: data.data, type: 'audio'});
          }
        },
        {
          id: 'mainVideo',
          ...
          onData: (data) => {
            meeting.webrtcStats.processStats({pc: meeting.mediaProperties.peerConnection, stats: data.data, type: 'video'});
          }
        },
        {
          id: 'mainShare',
          ...
          onData: (data) => {
            meeting.webrtcStats.processStats({pc: meeting.mediaProperties.peerConnection, stats: data.data, type: 'share'});
          }
        }
      ],
      receivers: [
