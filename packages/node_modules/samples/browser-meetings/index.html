...
<html lang="en">
  ...
  <body>
    <div id="main-container">
      ...
      <section>
        ...
        <form id="general-controls">
          <fieldset disabled>
            <legend>Selected meeting</legend>
            <div>        
              <select id="gc-meetings-list">
                  <option selected>No meetings available</option>
              </select>
              <p>Use the dropdown to select which meeting to manipulate.</p>
            </div>
          </fieldset>
          <fieldset disabled>
            ...
            <!-- div>
              <select id="gc-qualities">
                <option value="LOW">Low</option>
                <option value="MEDIUM">Medium</option>
                <option value="HIGH">High</option>
              </select>
              <button id="gc-set-quality" type="button">Set Quality</button>
              <label id="gc-quality">[[QUALITY STATE]]</label>
            </div -->
            <div>
        ...
        <form id="source-devices-controls">
          <fieldset>
            ...
            <div>
              ...
              <label id="audio-input-device"></label>
            </div>
            <div>
              ...
              <label id="audio-output-device"></label>
            </div>
            <div>
              ...
              <label id="video-input-device"></label>
            </div>
          </fieldset>
        </form>
    ...
    <aside id="code-viewer-container">
      <div class="tab">Hide Panel [X]</div>
    ...
    <!-- Helper documentation specific to this example only  -->
    <script src="lib/helper.documentation.js"></script>
  </body>
</html>
